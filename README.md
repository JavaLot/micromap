...
| | 2 | 4 | 8 | 16 | 32 | 64 | 128 |
| --- | --: | --: | --: | --: | --: | --: | --: |
| `flurry::HashMap` | 260.31 | 80.60 | 13.37 | 18.82 | 7.99 | 5.38 | 2.65 |
| `hashbrown::HashMap` | 21.22 | 10.69 | 2.11 | 2.90 | 1.09 | 0.72 | 0.34 |
| `heapless::LinearMap` | 1.58 | 1.44 | 0.39 | 1.12 | 1.11 | 1.58 | 1.00 |
| `indexmap::IndexMap` | 16.16 | 14.07 | 3.22 | 4.67 | 1.90 | 1.32 | 0.63 |
| `linear_map::LinearMap` | 1.59 | 1.39 | 0.35 | 0.84 | 0.72 | 1.03 | 1.00 |
| `linked_hash_map::LinkedHashMap` | 26.84 | 20.03 | 4.75 | 6.05 | 2.30 | 1.59 | 0.77 |
| `litemap::LiteMap` | 1.64 | 2.06 | 1.38 | 3.57 | 1.31 | 1.03 | 0.58 |
| `micromap::Map` 👍 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 |
| `nohash_hasher::BuildNoHashHasher` | 24.68 | 10.92 | 2.35 | 2.69 | 1.04 | 0.77 | 0.37 |
| `rustc_hash::FxHashMap` | 20.74 | 10.92 | 2.28 | 2.66 | 0.87 | 0.60 | 0.31 |
| `std::collections::BTreeMap` | 37.74 | 14.66 | 3.25 | 5.26 | 1.97 | 1.41 | 0.78 |
| `std::collections::HashMap` | 20.93 | 12.91 | 2.74 | 3.93 | 1.71 | 1.24 | 0.56 |
| `tinymap::array_map::ArrayMap` | 1.97 | 3.97 | 1.37 | 3.69 | 3.32 | 4.69 | 4.54 |

The experiment [was performed][action] on 04-11-2025.
