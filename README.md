...
| | 2 | 4 | 8 | 16 | 32 | 64 | 128 |
| --- | --: | --: | --: | --: | --: | --: | --: |
| `flurry::HashMap` | 317.69 | 87.52 | 27.31 | 21.12 | 11.90 | 6.33 | 2.48 |
| `hashbrown::HashMap` | 27.92 | 11.68 | 4.04 | 2.94 | 1.50 | 0.68 | 0.24 |
| `heapless::LinearMap` | 1.18 | 1.52 | 0.76 | 1.27 | 1.11 | 1.67 | 0.75 |
| `indexmap::IndexMap` | 14.75 | 14.92 | 6.09 | 5.35 | 2.91 | 1.54 | 0.60 |
| `linear_map::LinearMap` | 1.41 | 1.45 | 0.64 | 0.94 | 1.23 | 0.99 | 0.78 |
| `linked_hash_map::LinkedHashMap` | 25.62 | 22.79 | 7.68 | 6.82 | 3.49 | 1.87 | 0.74 |
| `litemap::LiteMap` | 1.40 | 2.45 | 3.85 | 3.68 | 2.04 | 1.25 | 0.56 |
| `micromap::Map` 👍 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 |
| `nohash_hasher::BuildNoHashHasher` | 26.96 | 12.53 | 4.51 | 2.53 | 1.29 | 0.71 | 0.27 |
| `rustc_hash::FxHashMap` | 28.50 | 13.46 | 3.71 | 2.67 | 1.02 | 0.56 | 0.21 |
| `std::collections::BTreeMap` | 16.60 | 8.03 | 3.05 | 3.80 | 2.30 | 1.33 | 0.60 |
| `std::collections::HashMap` | 32.87 | 15.39 | 5.62 | 4.74 | 2.49 | 1.35 | 0.52 |
| `tinymap::array_map::ArrayMap` | 3.02 | 4.19 | 2.66 | 4.65 | 4.94 | 5.45 | 4.49 |

The experiment [was performed][action] on 24-09-2026.
