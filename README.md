...
| | 2 | 4 | 8 | 16 | 32 | 64 | 128 |
| --- | --: | --: | --: | --: | --: | --: | --: |
| `flurry::HashMap` | 307.74 | 82.70 | 40.00 | 18.84 | 10.48 | 5.37 | 2.33 |
| `hashbrown::HashMap` | 21.24 | 10.96 | 6.19 | 2.83 | 1.37 | 0.83 | 0.27 |
| `heapless::LinearMap` | 1.42 | 1.35 | 1.14 | 1.06 | 0.99 | 1.53 | 1.23 |
| `indexmap::IndexMap` | 12.83 | 10.72 | 7.16 | 3.54 | 1.92 | 1.00 | 0.42 |
| `linear_map::LinearMap` | 1.60 | 1.38 | 1.03 | 0.77 | 1.05 | 0.97 | 0.86 |
| `linked_hash_map::LinkedHashMap` | 26.84 | 20.00 | 11.94 | 5.82 | 3.12 | 1.55 | 0.67 |
| `litemap::LiteMap` | 1.78 | 2.20 | 4.22 | 3.22 | 1.68 | 1.00 | 0.50 |
| `micromap::Map` 👍 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 |
| `nohash_hasher::BuildNoHashHasher` | 20.58 | 10.96 | 6.75 | 2.67 | 1.35 | 0.69 | 0.32 |
| `rustc_hash::FxHashMap` | 20.85 | 10.89 | 6.23 | 2.64 | 1.23 | 0.63 | 0.27 |
| `std::collections::BTreeMap` | 21.59 | 14.41 | 9.67 | 5.26 | 2.58 | 1.36 | 0.67 |
| `std::collections::HashMap` | 21.39 | 12.99 | 8.04 | 3.91 | 2.20 | 1.14 | 0.48 |
| `tinymap::array_map::ArrayMap` | 1.99 | 3.91 | 4.01 | 3.68 | 4.03 | 4.75 | 3.92 |

The experiment [was performed][action] on 29-08-2025.
There were 1000000 repetitions.
The entire benchmark took 279s.
Uname: 'Linux'.
