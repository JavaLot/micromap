...
| | 2 | 4 | 8 | 16 | 32 | 64 | 128 |
| --- | --: | --: | --: | --: | --: | --: | --: |
| `flurry::HashMap` | 303.09 | 78.92 | 41.25 | 19.11 | 10.57 | 5.62 | 2.39 |
| `hashbrown::HashMap` | 21.19 | 10.88 | 6.18 | 2.76 | 1.59 | 0.89 | 0.27 |
| `heapless::LinearMap` | 1.42 | 1.43 | 1.14 | 1.05 | 0.98 | 1.60 | 1.23 |
| `indexmap::IndexMap` | 12.76 | 10.82 | 7.25 | 3.62 | 1.93 | 1.02 | 0.42 |
| `linear_map::LinearMap` | 1.59 | 1.38 | 1.04 | 0.79 | 1.06 | 1.02 | 0.86 |
| `linked_hash_map::LinkedHashMap` | 26.71 | 19.99 | 12.26 | 5.86 | 3.04 | 1.62 | 0.67 |
| `litemap::LiteMap` | 1.77 | 2.18 | 4.43 | 2.62 | 1.71 | 1.04 | 0.51 |
| `micromap::Map` 👍 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 |
| `nohash_hasher::BuildNoHashHasher` | 20.55 | 10.96 | 6.87 | 2.65 | 1.36 | 0.71 | 0.32 |
| `rustc_hash::FxHashMap` | 20.79 | 10.88 | 6.23 | 2.63 | 1.23 | 0.66 | 0.28 |
| `std::collections::BTreeMap` | 21.58 | 14.37 | 9.93 | 5.19 | 2.59 | 1.44 | 0.67 |
| `std::collections::HashMap` | 21.13 | 13.03 | 8.02 | 3.88 | 2.22 | 1.14 | 0.48 |
| `tinymap::array_map::ArrayMap` | 1.98 | 3.90 | 4.02 | 3.65 | 4.05 | 4.94 | 3.93 |

The experiment [was performed][action] on 24-08-2025.
There were 1000000 repetitions.
The entire benchmark took 288s.
Uname: 'Linux'.
