...
| | 2 | 4 | 8 | 16 | 32 | 64 | 128 |
| --- | --: | --: | --: | --: | --: | --: | --: |
| `flurry::HashMap` | 280.73 | 74.90 | 37.44 | 21.35 | 11.42 | 4.35 | 2.76 |
| `hashbrown::HashMap` | 20.75 | 10.26 | 5.74 | 3.10 | 1.47 | 0.62 | 0.32 |
| `heapless::LinearMap` | 1.46 | 1.59 | 2.97 | 2.52 | 1.60 | 0.94 | 1.02 |
| `indexmap::IndexMap` | 16.60 | 14.16 | 8.85 | 5.24 | 2.81 | 1.17 | 0.67 |
| `linear_map::LinearMap` | 1.77 | 1.41 | 0.97 | 0.86 | 0.97 | 0.88 | 0.99 |
| `linked_hash_map::LinkedHashMap` | 28.74 | 21.33 | 10.93 | 6.45 | 3.50 | 1.43 | 0.82 |
| `litemap::LiteMap` | 1.70 | 2.01 | 4.22 | 3.19 | 2.01 | 0.91 | 0.63 |
| `micromap::Map` 👍 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 |
| `nohash_hasher::BuildNoHashHasher` | 20.46 | 10.71 | 6.71 | 2.74 | 1.56 | 0.68 | 0.37 |
| `rustc_hash::FxHashMap` | 20.38 | 10.31 | 5.84 | 2.71 | 1.29 | 0.55 | 0.31 |
| `std::collections::BTreeMap` | 21.14 | 16.92 | 11.84 | 7.53 | 3.68 | 1.46 | 1.00 |
| `std::collections::HashMap` | 20.52 | 12.57 | 7.71 | 4.38 | 2.53 | 1.04 | 0.60 |
| `tinymap::array_map::ArrayMap` | 2.00 | 4.13 | 3.85 | 4.28 | 5.00 | 4.52 | 5.26 |

The experiment [was performed][action] on 23-11-2025.
