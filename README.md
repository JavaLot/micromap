...
| | 2 | 4 | 8 | 16 | 32 | 64 | 128 |
| --- | --: | --: | --: | --: | --: | --: | --: |
| `flurry::HashMap` | 313.90 | 76.50 | 13.61 | 19.32 | 7.78 | 5.27 | 2.68 |
| `hashbrown::HashMap` | 21.12 | 10.95 | 2.10 | 2.66 | 1.01 | 0.67 | 0.39 |
| `heapless::LinearMap` | 1.58 | 1.43 | 0.39 | 1.08 | 1.11 | 1.51 | 1.00 |
| `indexmap::IndexMap` | 15.94 | 14.01 | 3.14 | 4.63 | 1.87 | 1.30 | 0.64 |
| `linear_map::LinearMap` | 1.58 | 1.39 | 0.35 | 0.84 | 0.87 | 0.97 | 0.99 |
| `linked_hash_map::LinkedHashMap` | 26.70 | 23.12 | 3.97 | 6.00 | 2.29 | 1.57 | 0.76 |
| `litemap::LiteMap` | 1.66 | 2.01 | 1.50 | 3.50 | 1.29 | 1.01 | 0.58 |
| `micromap::Map` 👍 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 |
| `nohash_hasher::BuildNoHashHasher` | 20.35 | 10.90 | 2.28 | 2.67 | 1.03 | 0.75 | 0.37 |
| `rustc_hash::FxHashMap` | 20.73 | 10.97 | 2.10 | 2.65 | 0.86 | 0.59 | 0.31 |
| `std::collections::BTreeMap` | 20.93 | 14.47 | 3.12 | 5.33 | 1.95 | 1.40 | 0.78 |
| `std::collections::HashMap` | 21.30 | 13.80 | 2.74 | 3.98 | 1.66 | 1.15 | 0.62 |
| `tinymap::array_map::ArrayMap` | 1.62 | 3.98 | 1.37 | 3.66 | 3.16 | 4.65 | 4.52 |

The experiment [was performed][action] on 26-10-2025.
